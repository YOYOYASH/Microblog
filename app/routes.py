...
def index():
    ...
    return render_template('index.html', title='Home', user=User, form=form, posts=posts.items, next_url=next_url,
                           prev_url=prev_url)
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        flash('Mail has been sent to the registered email ID for password reset.')
        return redirect(url_for('index'))
